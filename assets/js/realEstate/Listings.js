          ...
          <div className="col-md-3" key={index} >
              <div className="listing">
                  <div className="listing-img" style={{background:
                      'url("http://media.equityapartments.com/images/c_crop,x_0,y_0,w_1920,h_1080/c_fill,w_1920,h_1080/q_80/2500-1/longview-place-apartments-building.jpg") no-repeat center center'}}>
      ...
      return (
        <section id="listings">
            ...
            <section className="sortby-area">
                <div className="results">{this.props.globalState.filteredData.length} resuts found</div>
