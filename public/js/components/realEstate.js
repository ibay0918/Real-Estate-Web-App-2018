  ...
  _createClass(App, [{
    ...
    value: function filteredData() {
      ...
      if (this.state.city != "All") {
        var newData = newData.filter(function (item) {
    ...
    value: function populateForms() {
      ...
      //only pass new cities no repeat
      ...
      //only pass new home types no repeat
      ...
      //only pass new bedrooms no repeat
                ...
                if (_this2.props.globalState.view == 'box') {
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'listing-img', style: { background: 'url("http://media.equityapartments.com/images/c_crop,x_0,y_0,w_1920,h_1080/c_fill,w_1920,h_1080/q_80/2500-1/longview-place-apartments-building.jpg") no-repeat center center' } },
                                _react2.default.createElement(
                                    'span',
                                    { className: 'address' },
                                    listing.address
